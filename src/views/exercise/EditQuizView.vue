...
const method = ref(null); // Tipe soal aktif (1-6)
// --- LEVEL DIHAPUS ---
const objectValue = ref(null); // Khusus untuk method 5 (1=Warna, 2=Objek/Gambar)
const isDataSaved = ref(false); // Flag: False = Edit Judul, True = Edit Soal
...
// --- UPDATED: Metode digabung jadi satu list (Flat Array) & Tambah Aritmatika ---
...
// Computed Placeholder untuk Textarea
...
const submit = async () => {
    ...
    await api.put(`/exercise/${id}/quiz/${quizId}`, {
        ...
        // level: level.value, <--- DIHAPUS DARI PAYLOAD
