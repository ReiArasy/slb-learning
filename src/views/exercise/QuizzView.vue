...
const openQuestion = (id, index) => {
    ...
    // UPDATE: Menambahkan method 6 (Aritmatika) ke grup visual/tulis
    if ([1, 2, 4, 6].includes(questionActive.value.method)) {
...
const saveAnswer = () => {
    try {
        ...
        // UPDATE: Menambahkan method 6 (Aritmatika)
        if ([1, 2, 4, 6].includes(questionActive?.value?.method)) {
            // Logika untuk Gambar/Tulisan/Aritmatika
        ...
        if (!isAnswerValid) {
            ...
            const modeName = ([1, 2, 4, 6].includes(questionActive?.value?.method) && isCanvasMode.value) ?
                'Canvas' : ([1, 2, 4, 6].includes(questionActive?.value?.method) && !isCanvasMode.value) ?
        ...
        if (findAnswer) {
            Object.assign(findAnswer, answerData); 
        } else {
        ...
        <div class="page-body">
            ...
            <div class="grid-container">
                ...
                <div class="workspace" v-else>
                    ...
                    <p class="guide">
                        <span v-if="[1, 2, 4, 6].includes(questionActive?.method)">Jawab dengan menulis di kertas lalu
                    ...
                    <div class="workspace-body">
                        <div class="question-display">
                            ...
                            <h2
                                v-else-if="[2, 3, 4, 6].includes(questionActive?.method)">
                        ...
                        <div class="answer-box">
                            ...
                            <div v-if="[1, 2, 4, 6].includes(questionActive?.method)" class="input-mode-selector">
                            ...
                            <br v-if="[1, 2, 4, 6].includes(questionActive?.method)">

                            <div v-if="[1, 2, 4, 6].includes(questionActive?.method) && isCanvasMode">
                                <CanvasDrawerComponent v-model:file="canvasBase64" ref="canvasRef" />
                            </div>

                            <div v-else-if="[1, 2, 4, 6].includes(questionActive?.method) && !isCanvasMode">
